...
namespace Our.Community.Configuration._17.Composers
{
    public class OurCommunityConfiguration17ApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Our Community Configuration 17Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<OurCommunityConfiguration17OperationSecurityFilter>();
            });
        }

        public class OurCommunityConfiguration17OperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Our.Community.Configuration._17.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
